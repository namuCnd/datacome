	...
	$.fn.popWindow = function(method){
		var methods = {
				init:function(params){
					...
					var opt = '';
					opt += '   width='+_options.width;
					opt += ' , height='+_options.height;
					opt += ' , top='+_options.top;
					opt += ' , left='+_options.left;
					
					//console.log(opt);
					var w = window.open('','popWindow',opt);
...
(function($) {
	$.fn.popModal = function(method) {
			...
			init : function(params) {
				...
				function _init() {
					...
					if (elem.next('div').hasClass(elemClass)) {
						...
						var tooltipContainer = $('<div class="' + elemClass + ' ' + _options.placement + ' animated" ttt style="' + isFixed + '"></div>');
						var tooltipContent = $('<div class="' + elemClass + '_content ' + (_options.overflow?elemClass + '_contentOverflow':'')+'"></div>');
		...
		function getPlacement() {
			...
			absTop = _options.top,
			absLeft = _options.left,
			absWidth = _options.width,
			absHeight = _options.height
			;
		...
		var methods = {
			init : function(params) {
				...
				function _init() {
					...
					dialogContainer = $('<div class="' + elemClass + '_container"></div>').css({
						top: _options.top + 'px',
